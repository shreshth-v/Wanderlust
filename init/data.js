const sampleListings = [
    ...
    },
    {
      ...
      geometry: {
          type: "Point",
          coordinates: [-74.0060, 40.7128]  // Coordinates for New York City, United States
      }
  },
  {
      ...
      geometry: {
          type: "Point",
          coordinates: [-106.8230, 39.1911]  // Coordinates for Aspen, United States
      }
  },
  {
  ...
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [-122.6765, 45.5231]  // Coordinates for Portland, United States
    }
  },
  {
      ...
      geometry: {
          type: "Point",
          coordinates: [-86.8515, 21.1743]  // Coordinates for Cancun, Mexico
      }
  },
  {
      ...
      geometry: {
          type: "Point",
          coordinates: [-120.0312, 38.9390]  // Coordinates for Lake Tahoe, United States
      }
  },
  {
  ...
  },
  {
      ...
      geometry: {
          type: "Point",
          coordinates: [7.2275, 46.0940]  // Coordinates for Verbier, Switzerland
      }
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [34.9000, -2.3333]  // Coordinates for Serengeti National Park, Tanzania
    }
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [4.9009, 52.3676]  // Coordinates for Amsterdam, Netherlands
    }
  },
  {
  ...
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [-1.8283, 51.9000]  // Coordinates for Cotswolds, United Kingdom
    }
  },
  {
  ...
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [115.1889, -8.3405]  // Coordinates for Bali, Indonesia
    }
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [-115.5730, 51.1784]  // Coordinates for Banff, Canada
    }
  },
  {
  ...
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [98.3000, 7.8804]  // Coordinates for Phuket, Thailand
    }
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [-4.0673, 57.0000]  // Coordinates for Scottish Highlands, United Kingdom
    }
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [55.2708, 25.2048]  // Coordinates for Dubai, United Arab Emirates
    }
  },
  {
  ...
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [25.3289, 37.4370]  // Coordinates for Mykonos, Greece
    }
  },
  {
  ...
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [-79.9311, 32.7765]  // Coordinates for Charleston, United States
    }
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [139.6917, 35.6762]  // Coordinates for Tokyo, Japan
    }
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [-71.5724, 43.1939]  // Coordinates for New Hampshire, United States
    }
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [73.5296, 3.2028]  // Coordinates for Maldives
    }
  },
  {
  ...
  },
  {
    ...
    geometry: {
        type: "Point",
        coordinates: [-84.8700, 9.7489]  // Coordinates for Costa Rica
    }
  }
  ];
...
//       title: "Historic Brownstone in Boston",
//       description:
//           "Live like a local in this historic brownstone, offering a unique blend of history and modernity.",
//       image: "https://images.unsplash.com/photo-1515524738708-327f6b0037e4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8c2t5JTIwdmFjYXRpb258ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60",
//       price: 2500,
//       location: "Boston",
//       country: "United States",
//   },
